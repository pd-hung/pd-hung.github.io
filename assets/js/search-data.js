...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "A collection of in progress and completed projects.",
          section: "Navigation",
          handler: () => {
          ...
          title: "publications",
          description: "A none existence list of publications in reverse chronological order. (Working towards it!)",
          section: "Navigation",
          handler: () => {
